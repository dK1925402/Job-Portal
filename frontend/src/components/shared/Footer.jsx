      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col space-y-4">
            <h2 className="text-2xl text-orange-600 font-extrabold">Sarvagya Nirakar</h2>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://linkedin.com" className="text-white hover:text-blue-700 transition-colors" aria-label="LinkedIn">
          ...
          <div className="flex flex-col space-y-4 pt-2">
           ...
           <a href="https://chat.whatsapp.com/JnikmOrj1Uo78vziNxsMIz"><div className="text-lg font-semibold bg-green-600 p-4 rounded-xl flex items-center justify-center">   
           <FaWhatsapp  className='m-2' />
             Join Our Community</div></a>

             <a href="https://linktr.ee/sarvagyanirakarcommunity?utm_source=linktree_admin_share"><div className="text-lg font-semibold bg-orange-500 p-4 rounded-xl flex items-center justify-center">   
